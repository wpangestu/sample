          ...
          <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Bank Pembayaran</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">

                    <a href="{{route('bank_payments.create')}}" class="btn btn-primary mb-3">Tambah</a>
...
<script>
    $(document).ready(function(){
        ...
        let table = $('#table-datatables').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('bank_payments.index') }}",
            columns: [
