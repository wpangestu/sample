      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">Withdraw Customer</li>
        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header">
                <h3 class="card-title">Detail Penarikan Customer</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <dl class="row">
                  ...
                  @endif
                    <a href="{{ route('withdraw.customer.index') }}" class="btn btn-sm btn-secondary"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
                  </dd>
                </dl>
