                    ...
                    @endif
                        ...
                        <form action="{{route('promos.update',$promo->id)}}" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="name" class="form-control" id="inputName" value="{{ old('name',$promo->name) }}" placeholder="Nama">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputLongGuarantee" class="col-sm-3 col-form-label">Kode Promo*</label>
                                <div class="col-sm-9">
                                    <input type="text" name="promo_code" class="form-control" value="{{ old('promo_code',$promo->code) }}" id="inputLongGuarantee">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputIcon" class="col-sm-3 col-form-label">Nilai Potongan (IDR)*</label>
                                <div class="col-sm-9">
                                    <input type="number" name="value" class="form-control" value="{{ old('value',$promo->value) }}" id="inputLongGuarantee">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputDesc" class="col-sm-3 col-form-label">Deskripsi</label>
                                <div class="col-sm-9">
                                    <textarea class="form-control" name="description" id="inputDesc" cols="30" rows="5">{{ old('description',$promo->description) }}</textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                  <select required name="inputStatus" class="form-control">
                                    ...
                                    <option value="on" {{ $promo->is_active?'selected':'' }}>Aktif</option>
                                    <option value="off" {{ !($promo->is_active)?'selected':'' }}>Non Aktif</option>
                                  </select>
                                </div>
                            </div>
                            <div class="form-group row">
