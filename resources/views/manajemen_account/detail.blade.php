          ...
          <div class="card">
              ...
              <div class="card-body">
                ...
                <dl class="row">
                  ...
                  <dd class="col-sm-8">: @foreach($data->roles as $role)
                                            <span class="badge badge-info">{{$role->name=="cs"?"customer service":$role->name}}</span>
                                        @endforeach
                  </dd>
                  ...
                  <dt class="col-sm-3">Login Terakhir</dt>
                  <dd class="col-sm-8">: <b>{{ $data->last_login??'-' }}</b></dd>
                  <!-- <dt class="col-sm-3"></dt>
                  <dd class="col-sm-8"><a href="{{ route('manajement_account.index') }}" class="btn btn-sm btn-secondary"><i class="fa fa-arrow-circle-left"></i> Kembali</a></dd> -->
                </dl>
                <hr>
                <div class="row"></div>
                <dl>
