...
@section('title','Ubah Akun Pengguna')
@section('content')
        ...
        <div class="row">
          ...
          <div class="card">
              ...
              <div class="card-body">
                    ...
                    @endif
                <form action="{{route('manajement_account.update',$data->id)}}" enctype="multipart/form-data" method="post">
                @method('put')
                <div class="row">
                    <div class="col-md-6"> 
                            @csrf
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ old('name',$data->name) }}" name="name" id="inputNama">
                        </div>
                        <div class="form-group">
                            <label for="inputEmail" class="col-form-label">Email</label>
                            <input type="email" class="form-control" name="email" value="{{ old('email',$data->email) }}" id="inputEmail">
                        </div>
                        <div class="form-group">
                            <label for="inputPhone" class="col-form-label">Phone</label>
                            <input type="text" class="form-control" name="phone" value="{{old('phone',$data->phone)}}" id="inputPhone">
                        </div>
                        <div class="form-group">
                            <label for="inputAddress" class="col-form-label">Alamat</label>
                            <textarea name="address" class="form-control" id="inputAddress" cols="30" rows="3">{{ old('address',$data->address) }}</textarea>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="icheck-primary">
                                <input name="role[]" type="checkbox" value="admin" id="cb_role_admin"/ {{ in_array('admin',$data->roles->pluck('name')->toArray())?'checked':'' }}>
                                <label for="cb_role_admin">admin</label>
                            </div>
                            <div class="icheck-primary">
                                <input name="role[]" type="checkbox" value="cs" id="cb_role_cs" {{ in_array('cs',$data->roles->pluck('name')->toArray())?'checked':'' }} />
